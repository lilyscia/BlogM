        ...
        <div class="table-responsive">      
            ...
            <?php foreach ($comments as $comment): ?>
              <tr>
                ...
                <td>
					<a class="btn btn-success operation" title="Valider" href="admin/enableComment/<?= $this->sanitize($comment->getId()) ?>">
						<i class="fas fa-check"></i>
					</a>
                	<a class="btn btn-danger operation" title="Supprimer" href="admin/deleteComment/<?= $this->sanitize($comment->getId()) ?>" onclick="return confirm('Cette action supprimera ce commentaire de façon permanente. Êtes vous sûr ?')">
