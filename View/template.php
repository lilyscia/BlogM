...
<html lang="fr">
  <head>
    ...
    <meta name="description" content="Blog personnel">
    <meta name="author" content="Alice Dejean">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand" href="home"><img src="Content/startbootstrap-clean-blog-gh-pages/img/A.d.png" width="100" height="90" alt="site logo"> </a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="postList">Articles</a>
            </li>
            <li class="nav-item">
        ...
        <div class="row">
          <div class="col-lg-8 col-md-10 mx-auto">
            <ul class="list-inline text-center">
              ...
              <li class="list-inline-item">
                <a href="https://github.com/lilyscia" target="_blank">
                  <span class="fa-stack fa-lg">
                    <i class="fas fa-circle fa-stack-2x"></i>
            ...
            <p class="copyright text-muted">Copyright &copy; alice-dejean.com/blog 2021</p>
            <?php
            if(isset($_SESSION['userType']) && $_SESSION['userType'] === 'admin')
            {
            ?>
