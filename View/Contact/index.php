...
<!-- Page Header -->
<header class="masthead" style="background-image: url('Content/startbootstrap-clean-blog-gh-pages/img/paper.jpg')">
...
<div class="container">
  <div class="row">
    ...
    <p class="help-block text-success"><?= $successMessage ?></p>
      <p>Une question? Remplissez le formulaire ci-dessous, vous aurez une réponse dès que possible !</p>
